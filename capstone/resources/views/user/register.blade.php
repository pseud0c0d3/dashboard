...
<body>
    ...
    <script>
        // Disable the submit button and change its color when the form is submitted
        $('#registrationForm').on('submit', function(event) {
            // Disable the submit button and change its color
            $('#submitBtn').prop('disabled', true).addClass('disabled-btn');  // Disable button and add grey color
        });
    </script>
</body>
</html>
