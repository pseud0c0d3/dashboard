...
<body>
  <!-- Background Image -->
  <img src="/img/animal.jpg" alt="Background Image" class="background">
...
<div id="timer" style="font-size: 20px; font-weight: bold; text-align: center; margin-bottom: 10px;">Time: 0s</div>
    ...
    <p id="highest-score-game">Highest Score: 0</p> <!-- Game section highscore -->
...
<div id="game-over-modal" class="modal">
    <div class="modal-content">
        ...
        <p id="highest-score-modal">Highest Score: 0</p> <!-- Modal highscore -->
