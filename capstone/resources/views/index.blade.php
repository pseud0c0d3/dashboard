...
<body>
    ...
    <header class="jumbotron text-center" style="background-image: url('bck.png'); background-size: cover; background-position: center;">
        <div class="container">
    ...
    <div class="empowering-families-container"> 
        <div class="row">
            <div class="col-md-6">
                <img src="pic2.png" alt="Empowering Families" class="empowering-families-image">
            </div>
    ...
    <div class="additional-container" style="background-image: url('pic4.png'); background-size: cover; background-position: center; height: auto; padding: 0;">
            ...
            <div class="row" style="height: 100%;">
                <div class="col-md-4 d-flex align-items-center justify-content-center">
                    <div class="box founder-box text-center p-4" style="background-color: white; border-radius: 10px; width: 90%;">
                        ...
                        <img src="founder.png" alt="Founder" class="img-fluid rounded-circle mb-2" style="width: 150px; height: 150px;">
        ...
        <div class="modal-content" style="height: 90vh;">
            <div class="row no-gutters" style="height: 100%;">
                <div class="col-md-6" style="height: 100%;">
                    <img src="modpic.jpg" class="img-fluid" alt="Family Image" style="width: 100%; height: 100%; object-fit: cover;">
                </div>
                <div class="col-md-6 d-flex flex-column justify-content-between" style="height: 100%; padding: 20px;">
                    ...
                    <div class="modal-body text-center">
                        <!-- Logo Section -->
                        <img src="icon.png" alt="Logo" class="logo-img" style="max-width: 80%; margin-bottom: 20px;">
